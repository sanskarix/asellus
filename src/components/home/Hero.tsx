    ...
    >
      ...
      <div className="editorial-container relative z-10 pt-20 flex flex-col items-center text-center md:items-start md:text-left">
        ...
        >
          ...
          <h1 className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8 leading-relaxed font-sans font-normal tracking-normal">
            <motion.div
              variants={{
                hidden: { opacity: 0 },
                visible: { opacity: 1 }
            ...
            >
              Growth marketing agency for brands that care about ROI.
            </motion.div>
          </h1>
