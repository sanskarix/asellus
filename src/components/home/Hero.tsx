...
export function Hero() {
  ...
  const MAX_PARTICLES = 90; // Maximum number of stars on screen at once. Lower = less crowded, better performance. (40-80 recommended)
  const SPAWN_INTERVAL = 50; // Milliseconds between spawning new particles. Higher = fewer spawns, lower density. (80-150 recommended)
